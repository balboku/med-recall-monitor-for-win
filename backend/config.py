...
CRAWL_INTERVAL_MDCG = int(os.getenv("CRAWL_INTERVAL_MDCG", "168"))               # 每週
CRAWL_INTERVAL_FDA_GUIDANCE = int(os.getenv("CRAWL_INTERVAL_FDA_GUIDANCE", "168")) # 每週
CRAWL_INTERVAL_TFDA_REGULATIONS = int(os.getenv("CRAWL_INTERVAL_TFDA_REGULATIONS", "168")) # 每週
